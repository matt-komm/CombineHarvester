...
def makeCanvas(ymin=0,ymax=2.1):
    ...
    cv.cd(1)
    axis1 = ROOT.TH2F("axis"+str(random.random()),";c#tau#lower[0.3]{#scale[0.7]{0}} (m);95% CL lower limit on m#kern[-0.5]{ }#lower[0.2]{#scale[0.8]{#tilde{g}}} (TeV)",
        50,10**-5.2,10**1.2,
        50,ymin,ymax
    )
...
pInfo1.AddText(mgSymbol+"#kern[-0.2]{ }#minus#kern[-0.2]{ }"+mchiSymbol+" =#kern[-0.2]{ }100 GeV")
...
pInfo2.AddText("pp#kern[-0.5]{ }#rightarrow#kern[-0.5]{ }"+gSymbol+"#kern[-0.6]{ }"+gSymbol+", "+gSymbol+"#kern[-0.5]{ }#rightarrow#kern[-0.5]{ }q#kern[-0.7]{ }q#lower[-0.8]{#kern[-0.89]{#minus}}#kern[-0.6]{ }"+chiSymbol+"#kern[-0.8]{ }, "+mchiSymbol+" =#kern[-0.2]{ }100 GeV")
pInfo2.SetTextFont(43)
pInfo2.SetTextSize(27)
pInfo2.SetTextAlign(13)

legend1 = ROOT.TLegend(cvxmin+0.03,cvymin+0.03+0.11,cvxmin+0.03+0.45,cvymin+0.03)
legend1.SetFillStyle(0)
legend1.SetBorderSize(0)
legend1.SetTextFont(43)
legend1.SetTextSize(27)
legend1.AddEntry(graphC,"LLP jet tagger","PLF")
#legend1.AddEntry(graphCnoda,"w/o DA","L")
legend1.AddEntry(graphC_SUS,"JHEP 05 (2018) 025","PL")

legend2 = ROOT.TLegend(cvxmin+0.03,cvymin+0.03+0.11,cvxmin+0.03+0.45,cvymin+0.03)
legend2.SetFillStyle(0)
legend2.SetBorderSize(0)
legend2.SetTextFont(43)
legend2.SetTextSize(27)
legend2.AddEntry(graphU,"LLP jet tagger","PLF")
#legend2.AddEntry(graphUnoda,"w/o DA","L")
legend2.AddEntry(graphU_SUS,"JHEP 05 (2018) 025","PL")
